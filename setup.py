...
DESCRIPTION = metadata.get('description', 'Deep Learning model that classifies fruit images ')
AUTHOR = metadata.get('author', 'Hamza')
AUTHOR_EMAIL = metadata.get('author_email', 'hamzafarrukh73@gmail.com')
